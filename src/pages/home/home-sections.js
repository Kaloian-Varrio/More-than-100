    ...
    <section class="home-hero" aria-labelledby="hero-title">
      <div class="container position-relative py-5 py-lg-6">
        <div class="row align-items-center g-5">
          <div class="col-lg-7">
            <h1 class="hero-headline mb-5" id="hero-title"><span class="hero-headline__small">Small</span> choices. <span class="hero-headline__smart">Smart</span> actions. A <span class="hero-headline__life">longer, healthier life.</span></h1>
...
export function createAssessmentPromotionSection() {
  const benefits = [
    ...
    ['journals', 'Five relevant articles', 'Receive practical reading selected from real More Than 100 content.'],
  ];
